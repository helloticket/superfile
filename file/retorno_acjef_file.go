...
func (r *retornoACJEFFile) decodeSegmento(row string) model.Segmento {
...
func (r *retornoACJEFFile) decodeFileHeader(row string) map[string]interface{} {
...
func (r *retornoACJEFFile) decodeFileTrailer(row string) map[string]interface{} {
...
func (r *retornoACJEFFile) getLayoutFor(name string) map[interface{}]interface{} {
